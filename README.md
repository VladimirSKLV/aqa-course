...
> Обновление: Kotlin Beginner/Advanced дополнены расширенным набором уроков, включая отдельный API-раздел и практику запуска API smoke-автотестов прямо из приложения.
